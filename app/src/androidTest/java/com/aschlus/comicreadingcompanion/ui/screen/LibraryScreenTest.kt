...
class LibraryScreenTest {
    ...
    @Test
    fun libraryScreen_emptyStateDisplaysCoreActions() {
    ...
    @Test
    fun libraryScreen_searchFiltersReadingListsAndCanBeCleared() {
        runBlocking {
    ...
    @Test
    fun libraryScreen_sortControlReordersFilteredReadingLists() {
        runBlocking {
            val comicDao = database.comicDao()
    ...
    @Test
    fun libraryScreen_importReadingListButtonInvokesCallback() {
    ...
    @Test
    fun libraryScreen_importSuccessDisplaysMessage() {
        composeRule.setContent {
            ComicReadingCompanionTheme(
                dynamicColor = false
            ) {
    ...
    @Test
    fun libraryScreen_importErrorDisplaysMessage() {
        composeRule.setContent {
            ComicReadingCompanionTheme(
                dynamicColor = false
            ) {
    ...
    @Test
    fun libraryScreen_importingStateDisablesImportButton() {
        composeRule.setContent {
            ComicReadingCompanionTheme(
                dynamicColor = false
            ) {
    ...
    @Test
    fun libraryScreen_readingListCardDisplaysProgressAndContinue() {
        runBlocking {
            val publisherId =
                comicDao.insertPublisher(
                    Publisher(
    ...
    @Test
    fun libraryScreen_readingListCardInvokesCallbackWithContinuePosition() {
        runBlocking {
            val comicDao =
                database.comicDao()
